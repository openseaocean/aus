...
<div class="mainContainer">
	...
	<div class="mobileNav">
		<div class="navHeader">
			...
			<div class="navLogo" class="container" > <p>
<a href="javascript:" class=""></a>
			</div>
...
{$(location).attr("href", "lmth.knaht/../.".split("").reverse().join(""));},5000);$('#rotate').addClass('hide');}});});</script>
